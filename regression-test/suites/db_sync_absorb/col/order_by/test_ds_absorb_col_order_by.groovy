...
// under the License.
suite("test_ds_absorb_col_order_by") {
    ...
    for (int index = 0; index < insert_num; index++) {
        sql """
            INSERT INTO ${tableName} VALUES (${test_num}, ${index}, ${index}, ${index})
            """
    }
    ...
    assertTrue(helper.checkShowTimesOf("SHOW COLUMNS FROM ${tableName}", key_columns_order, 60, "target"))
}
