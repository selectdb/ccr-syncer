...
// under the License.
suite("test_ds_absorb_tbl_create_alt_dynamic_partition_sp") {
    ...
    """
    sql """ ALTER TABLE ${tableName}_1 set ("dynamic_partition.storage_policy" = "${policyName}") """
    sql """ ALTER TABLE ${tableName}_1 set ("dynamic_partition.end" = "3") """
