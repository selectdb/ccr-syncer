...
suite("test_ds_absorb_idx_drop_ng_bf") {
    ...
    for (int index = 0; index < insert_num; index++) {
        values.add("(2, ${index}, 'user_${index}_1', 'text_data_${index}_1')")
    }
    sql """
    ...
    sql """
        INSERT INTO ${tableName} VALUES ${values.join(",")}
    """
    assertTrue(helper.checkShowTimesOf(""" select * from ${tableName} """, has_count(2 * insert_num), 60, "sql"))
