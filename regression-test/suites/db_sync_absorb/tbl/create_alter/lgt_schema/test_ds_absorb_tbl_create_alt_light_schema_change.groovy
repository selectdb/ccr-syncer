...
// under the License.
suite("test_ds_absorb_tbl_create_alt_light_schema_change") {
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${tableName}_1", notLightSchemaChange, 60, "sql"))
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${tableName}_1", notLightSchemaChange, 60, "target"))
    ...
    sql """ALTER TABLE ${tableName}_1 SET ("light_schema_change" = "true");"""
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${tableName}_1", lightSchemaChange, 60, "sql"))
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${tableName}_1", notLightSchemaChange, 60, "target"))
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${tableName}_1", lightSchemaChange, 60, "sql"))
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${tableName}_1", lightSchemaChange, 60, "target"))
}