...
suite("test_tsa_col_alter_type") {
    ...
    assertTrue(helper.checkShowTimesOf("SHOW COLUMNS FROM `${aliasTableName}`", id_is_big_int, 60, "target_sql"))
    ...
    assertTrue(helper.checkShowTimesOf("SHOW COLUMNS FROM ${aliasTableName}", value_is_big_int, 60, "target_sql"))
}
