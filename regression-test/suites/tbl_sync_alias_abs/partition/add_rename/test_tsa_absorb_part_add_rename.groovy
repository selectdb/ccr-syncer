...
// under the License.
suite("test_tsa_absorb_part_add_rename") {
    ...
    assertTrue(helper.checkShowTimesOf(""" show create table ${aliasTableName} """, notRenamePartition, 60, "target"))
    ...
    assertTrue(helper.checkShowTimesOf(""" show create table ${aliasTableName} """, renamePartition, 60, "target"))
}