...
// under the License.
suite("test_tsa_absorb_tbl_truncate") {
    ...
    sql "TRUNCATE TABLE ${tableName}_0"
    assertTrue(helper.checkShowTimesOf(""" select * from ${tableName}_0 """, { r -> r.size() == 0 }, 60, "sql"))
    ...
    helper.force_fullsync("${tableName}_0")
