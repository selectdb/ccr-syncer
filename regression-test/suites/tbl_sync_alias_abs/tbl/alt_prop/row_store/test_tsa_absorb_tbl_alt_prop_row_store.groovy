...
// under the License.
suite("test_tsa_absorb_tbl_alt_prop_row_store") {
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${aliasTableName}", notExistRowStore, 60, "target"))
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${tableName}", existRowStore, 60, "sql"))
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${aliasTableName}", existRowStore, 60, "target"))
}