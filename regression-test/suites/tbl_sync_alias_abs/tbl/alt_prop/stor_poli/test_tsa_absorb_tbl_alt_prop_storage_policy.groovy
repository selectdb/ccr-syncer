...
// under the License.
suite("test_tsa_absorb_tbl_alt_prop_storage_policy") {
    ...
    def resource_name = "test_tsa_absorb_tbl_alt_prop_storage_policy_resource" + helper.randomSuffix()
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${aliasTableName}", notExistPolicy, 60, "target"))
