...
// under the License.
suite("test_tsa_absorb_tbl_alt_prop_compaction") {
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${aliasTableName}", existOldCompaction, 60, "target"))
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${tableName}", existNewCompaction, 60, "sql"))
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${aliasTableName}", existNewCompaction, 60, "target"))
}