...
// under the License.
suite("test_tsa_absorb_tbl_alt_prop_dynamic_partition_sp") {
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${aliasTableName}", { res -> return res[0][1].contains("\"dynamic_partition.end\" = \"3\"")}, 60, 'target'))
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${aliasTableName}", { res -> return !res[0][1].contains("\"dynamic_partition.storage_policy\" = \"${policyName}\"")}, 60, 'target'))
