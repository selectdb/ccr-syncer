...
// under the License.
suite("test_tsa_absorb_tbl_alt_prop_dy_part") {
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${aliasTableName}", existOldPartitionProperty, 60, "target"))
    ...
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${tableName}", existNewPartitionProperty, 60, "sql"))
    assertTrue(helper.checkShowTimesOf("SHOW CREATE TABLE ${aliasTableName}", existNewPartitionProperty, 60, "target"))
}