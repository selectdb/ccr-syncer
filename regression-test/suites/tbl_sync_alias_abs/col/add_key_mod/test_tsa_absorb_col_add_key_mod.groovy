...
// under the License.
suite("test_tsa_absorb_col_add_key_mod") {
    ...
    def value_is_big_int = { res -> Boolean
        ...
        return res[3][0] == 'value' && res[3][1] == 'bigint'
    }

    def id_is_big_int = { res -> Boolean
        // Field == 'id' && 'Type' == 'bigint'
        return res[2][0] == 'id' && res[2][1] == 'bigint'
    }
    ...
    for (int index = insert_num * 2; index < insert_num * 3; index++) {
        sql """
            INSERT INTO ${tableName} VALUES (${test_new_column_num}, ${test_num}, ${index}, ${index})
            """
    }
