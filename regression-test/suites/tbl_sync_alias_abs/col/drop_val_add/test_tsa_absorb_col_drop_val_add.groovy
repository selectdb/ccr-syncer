...
// under the License.
suite("test_tsa_absorb_col_drop_val_add") {
    ...
    assertTrue(helper.checkShowTimesOf(""" show columns from ${aliasTableName} """, { r -> return r.size() == 3 }, 60, "target"))
    assertTrue(helper.checkShowTimesOf(""" show columns from ${aliasTableName} """, { r -> return r[0][0] == 'id' }, 60, "target"))
    assertTrue(helper.checkShowTimesOf(""" show columns from ${aliasTableName} """, { r -> return r[2][0] == 'value1' }, 60, "target"))
}
