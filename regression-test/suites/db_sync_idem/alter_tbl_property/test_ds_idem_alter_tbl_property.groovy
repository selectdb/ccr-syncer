...
suite("test_ds_idem_alter_tbl_property") {
    ...
    helper.addFailpoint('handle_binlog_idempotent:before', 'MODIFY_TABLE_PROPERTY')
    helper.addFailpoint('handle_binlog_idempotent:after', 'MODIFY_TABLE_PROPERTY')
    sql """
