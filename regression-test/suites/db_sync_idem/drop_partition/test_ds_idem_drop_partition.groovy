...
suite('test_ds_idem_drop_partition') {
    ...
    helper.addFailpoint('handle_binlog_idempotent:before', 'DROP_PARTITION')
    helper.addFailpoint('handle_binlog_idempotent:after', 'DROP_PARTITION')
