...
suite('test_ds_idem_rename_rollup') {
    ...
    sql """
        ...
        ADD ROLLUP rollup_${tableName} (test, value)
        """
    ...
    helper.addFailpoint('handle_binlog_idempotent:before', 'RENAME_ROLLUP')
    helper.addFailpoint('handle_binlog_idempotent:after', 'RENAME_ROLLUP')

    sql """
        ALTER TABLE ${tableName}
        RENAME ROLLUP rollup_${tableName} rollup_${tableName}_new
    """
