...
suite('test_ds_idem_rename_column') {
    ...
    helper.addFailpoint('handle_binlog_idempotent:before', 'RENAME_COLUMN')
    helper.addFailpoint('handle_binlog_idempotent:after', 'RENAME_COLUMN')

    sql """
        ALTER TABLE ${tableName}
        RENAME COLUMN `value` `new_value`
    """
