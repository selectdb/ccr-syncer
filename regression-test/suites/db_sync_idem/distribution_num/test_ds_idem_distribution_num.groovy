...
suite('test_ds_idem_distribution_num') {
    ...
    helper.addFailpoint('handle_binlog_idempotent:before', 'MODIFY_DISTRIBUTION_BUCKET_NUM')
    helper.addFailpoint('handle_binlog_idempotent:after', 'MODIFY_DISTRIBUTION_BUCKET_NUM')
