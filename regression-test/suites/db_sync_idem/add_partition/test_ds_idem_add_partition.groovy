...
suite('test_ds_idem_add_partition') {
    ...
    helper.addFailpoint('handle_binlog_idempotent:before', 'ADD_PARTITION')
    helper.addFailpoint('handle_binlog_idempotent:after', 'ADD_PARTITION')

    logger.info('create a new table')
    sql """
        ALTER TABLE ${tableName} ADD PARTITION `p3` VALUES LESS THAN ("300")
    """
