...
suite("test_ds_prop_incrsync_incsync_group_commit") {
    ...
    sql """
        ...
        PROPERTIES (
            ...
            "binlog.enable" = "true",
            "group_commit_interval_ms" = "11000",
            "group_commit_data_bytes" = "134217729"
        )
    """
    ...
    assertTrue(target_res[0][1].contains("\"group_commit_interval_ms\" = \"11000\""))
    assertTrue(target_res[0][1].contains("\"group_commit_data_bytes\" = \"134217729\""))
