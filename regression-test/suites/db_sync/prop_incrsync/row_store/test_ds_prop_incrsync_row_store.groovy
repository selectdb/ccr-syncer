...
suite("test_ds_prop_incrsync_incsync_row_store") {
    ...
    assertTrue(target_res[0][1].contains("\"row_store_columns\" = \"test,id\""))
    assertTrue(target_res[0][1].contains("\"row_store_page_size\" = \"4096\""))
