...
// under the License.
suite("test_ts_idx_inverted_add_drop_multi") {
    ...
    sql """
        ALTER TABLE ${tableName}
            ADD INDEX idx_inverted_1 (value) USING INVERTED,
            ADD INDEX idx_inverted_2 (value1) USING INVERTED
        """
    sql "sync"
    ...
    assertTrue(show_indexes_result.any {
        it['Key_name'] == 'idx_inverted_2' && it['Index_type'] == 'INVERTED' })
    ...
    sql """
        ALTER TABLE ${tableName}
            DROP INDEX idx_inverted_1,
            DROP INDEX idx_inverted_2
        """
    sql "sync"
