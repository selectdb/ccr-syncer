...
// under the License.
suite("test_tsad_column_rename_column") {
    ...
    sql """
        ...
        RENAME COLUMN `id` `new_id`
        """
    assertTrue(helper.checkShowTimesOf(""" show columns from ${tableName} """, { r -> return r[1][0] == 'new_id' }, 60, "sql"))
    ...
    assertTrue(helper.checkShowTimesOf(""" show columns from ${aliasTableName} """, { r -> return r[1][0] == 'new_id' }, 60, "target"))
}
