...
// under the License.
suite("test_tsad_column_add_value") {
    ...
    sql """
        ...
        ADD COLUMN `last` INT DEFAULT "1" AFTER `id`
        """
    assertTrue(helper.checkShowTimesOf(""" show columns from ${tableName} """, { r -> return r[2][0] == 'last' }, 60, "sql"))
    ...
    assertTrue(helper.checkShowTimesOf(""" show columns from ${aliasTableName} """, { r -> return r[2][0] == 'last' }, 60, "target"))
}
