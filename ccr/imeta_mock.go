...
func (m *MockIMeta) DbExec(sql string) error {
	m.ctrl.T.Helper()
...
func (mr *MockIMetaMockRecorder) DbExec(sql interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DbExec", reflect.TypeOf((*MockIMeta)(nil).DbExec), sql)
}
...
func (m *MockIMeta) GetIndexIdMap(tableId, partitionId int64) (map[int64]*IndexMeta, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIMetaMockRecorder) GetIndexIdMap(tableId, partitionId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetIndexIdMap", reflect.TypeOf((*MockIMeta)(nil).GetIndexIdMap), tableId, partitionId)
}

// GetIndexNameMap mocks base method.
func (m *MockIMeta) GetIndexNameMap(tableId, partitionId int64) (map[string]*IndexMeta, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIMetaMockRecorder) GetIndexNameMap(tableId, partitionId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetIndexNameMap", reflect.TypeOf((*MockIMeta)(nil).GetIndexNameMap), tableId, partitionId)
}

// GetMasterToken mocks base method.
func (m *MockIMeta) GetMasterToken(rpcFactory rpc.IRpcFactory) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIMetaMockRecorder) GetMasterToken(rpcFactory interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMasterToken", reflect.TypeOf((*MockIMeta)(nil).GetMasterToken), rpcFactory)
}
...
func (m *MockIMeta) GetPartitionIdMap(tableId int64) (map[int64]*PartitionMeta, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIMetaMockRecorder) GetPartitionIdMap(tableId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPartitionIdMap", reflect.TypeOf((*MockIMeta)(nil).GetPartitionIdMap), tableId)
}
...
func (m *MockIMeta) GetPartitionRangeMap(tableId int64) (map[string]*PartitionMeta, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIMetaMockRecorder) GetPartitionRangeMap(tableId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPartitionRangeMap", reflect.TypeOf((*MockIMeta)(nil).GetPartitionRangeMap), tableId)
}
...
func (m *MockIMeta) GetTablets(tableId, partitionId, indexId int64) (*btree.Map[int64, *TabletMeta], error) {
	m.ctrl.T.Helper()
...
func (mr *MockIMetaMockRecorder) GetTablets(tableId, partitionId, indexId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTablets", reflect.TypeOf((*MockIMeta)(nil).GetTablets), tableId, partitionId, indexId)
}
...
func (m *MockIMeta) UpdateToken(rpcFactory rpc.IRpcFactory) error {
	m.ctrl.T.Helper()
...
func (mr *MockIMetaMockRecorder) UpdateToken(rpcFactory interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateToken", reflect.TypeOf((*MockIMeta)(nil).UpdateToken), rpcFactory)
}
