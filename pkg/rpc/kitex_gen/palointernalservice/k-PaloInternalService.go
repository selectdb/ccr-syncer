...
func (p *TQueryOptions) FastRead(buf []byte) (int, error) {
	...
	for {
		...
		case 142:
			if fieldTypeId == thrift.BOOL {
				l, err = p.FastReadField142(buf[offset:])
				offset += l
				if err != nil {
					goto ReadFieldError
				}
		...
		case 143:
			if fieldTypeId == thrift.BOOL {
				l, err = p.FastReadField143(buf[offset:])
				offset += l
				if err != nil {
					goto ReadFieldError
				}
		...
		case 144:
			if fieldTypeId == thrift.BOOL {
				l, err = p.FastReadField144(buf[offset:])
				offset += l
				if err != nil {
					goto ReadFieldError
				}
		...
		case 145:
			if fieldTypeId == thrift.BOOL {
				l, err = p.FastReadField145(buf[offset:])
				offset += l
				if err != nil {
					goto ReadFieldError
				}
		...
		case 146:
			if fieldTypeId == thrift.BOOL {
				l, err = p.FastReadField146(buf[offset:])
				offset += l
				if err != nil {
					goto ReadFieldError
				}
		...
		case 147:
			if fieldTypeId == thrift.I32 {
				l, err = p.FastReadField147(buf[offset:])
				offset += l
				if err != nil {
					goto ReadFieldError
				}
		...
		case 163:
			if fieldTypeId == thrift.BOOL {
				l, err = p.FastReadField163(buf[offset:])
				offset += l
				if err != nil {
					goto ReadFieldError
				}
		...
		case 164:
			if fieldTypeId == thrift.BOOL {
				l, err = p.FastReadField164(buf[offset:])
				offset += l
				if err != nil {
					goto ReadFieldError
				}
		...
		case 165:
			if fieldTypeId == thrift.I32 {
				l, err = p.FastReadField165(buf[offset:])
				offset += l
				if err != nil {
					goto ReadFieldError
				}
...
func (p *TQueryOptions) FastReadField142(buf []byte) (int, error) {
	offset := 0
	...
	if v, l, err := bthrift.Binary.ReadBool(buf[offset:]); err != nil {
		...
		p.EnableFixedLenToUint32V2 = v

	}
	return offset, nil
}

func (p *TQueryOptions) FastReadField143(buf []byte) (int, error) {
	offset := 0
	...
	if v, l, err := bthrift.Binary.ReadBool(buf[offset:]); err != nil {
		...
		p.EnableSharedExchangeSinkBuffer = v

	}
	return offset, nil
}

func (p *TQueryOptions) FastReadField144(buf []byte) (int, error) {
	offset := 0
	...
	if v, l, err := bthrift.Binary.ReadBool(buf[offset:]); err != nil {
		...
		p.EnableInvertedIndexSearcherCache = v

	}
	return offset, nil
}

func (p *TQueryOptions) FastReadField145(buf []byte) (int, error) {
	offset := 0
	...
	if v, l, err := bthrift.Binary.ReadBool(buf[offset:]); err != nil {
		...
		p.EnableInvertedIndexQueryCache = v

	}
	return offset, nil
}

func (p *TQueryOptions) FastReadField146(buf []byte) (int, error) {
	offset := 0
	...
	if v, l, err := bthrift.Binary.ReadBool(buf[offset:]); err != nil {
		...
		p.FuzzyDisableRuntimeFilterInBe = v

	}
	return offset, nil
}

func (p *TQueryOptions) FastReadField147(buf []byte) (int, error) {
	offset := 0
...
func (p *TQueryOptions) FastReadField163(buf []byte) (int, error) {
	offset := 0
	...
	if v, l, err := bthrift.Binary.ReadBool(buf[offset:]); err != nil {
		...
		p.InvertedIndexCompatibleRead = v

	}
	return offset, nil
}

func (p *TQueryOptions) FastReadField164(buf []byte) (int, error) {
	offset := 0
	...
	if v, l, err := bthrift.Binary.ReadBool(buf[offset:]); err != nil {
		...
		p.CheckOrcInitSargsSuccess = v

	}
	return offset, nil
}

func (p *TQueryOptions) FastReadField165(buf []byte) (int, error) {
	offset := 0
	...
	if v, l, err := bthrift.Binary.ReadI32(buf[offset:]); err != nil {
		...
		p.ExchangeMultiBlocksByteSize = v
...
func (p *TQueryOptions) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	...
	if p != nil {
		...
		offset += p.fastWriteField142(buf[offset:], binaryWriter)
		offset += p.fastWriteField143(buf[offset:], binaryWriter)
		offset += p.fastWriteField144(buf[offset:], binaryWriter)
		...
		offset += p.fastWriteField163(buf[offset:], binaryWriter)
		offset += p.fastWriteField164(buf[offset:], binaryWriter)
		offset += p.fastWriteField165(buf[offset:], binaryWriter)
...
func (p *TQueryOptions) fastWriteField142(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetEnableFixedLenToUint32V2() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "enable_fixed_len_to_uint32_v2", thrift.BOOL, 142)
		offset += bthrift.Binary.WriteBool(buf[offset:], p.EnableFixedLenToUint32V2)
...
func (p *TQueryOptions) fastWriteField143(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetEnableSharedExchangeSinkBuffer() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "enable_shared_exchange_sink_buffer", thrift.BOOL, 143)
		offset += bthrift.Binary.WriteBool(buf[offset:], p.EnableSharedExchangeSinkBuffer)
...
func (p *TQueryOptions) fastWriteField144(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetEnableInvertedIndexSearcherCache() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "enable_inverted_index_searcher_cache", thrift.BOOL, 144)
		offset += bthrift.Binary.WriteBool(buf[offset:], p.EnableInvertedIndexSearcherCache)
...
func (p *TQueryOptions) fastWriteField145(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetEnableInvertedIndexQueryCache() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "enable_inverted_index_query_cache", thrift.BOOL, 145)
		offset += bthrift.Binary.WriteBool(buf[offset:], p.EnableInvertedIndexQueryCache)
...
func (p *TQueryOptions) fastWriteField146(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetFuzzyDisableRuntimeFilterInBe() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "fuzzy_disable_runtime_filter_in_be", thrift.BOOL, 146)
		offset += bthrift.Binary.WriteBool(buf[offset:], p.FuzzyDisableRuntimeFilterInBe)
...
func (p *TQueryOptions) fastWriteField147(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *TQueryOptions) fastWriteField163(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetInvertedIndexCompatibleRead() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "inverted_index_compatible_read", thrift.BOOL, 163)
		offset += bthrift.Binary.WriteBool(buf[offset:], p.InvertedIndexCompatibleRead)
...
func (p *TQueryOptions) fastWriteField164(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetCheckOrcInitSargsSuccess() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "check_orc_init_sargs_success", thrift.BOOL, 164)
		offset += bthrift.Binary.WriteBool(buf[offset:], p.CheckOrcInitSargsSuccess)
...
func (p *TQueryOptions) fastWriteField165(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetExchangeMultiBlocksByteSize() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "exchange_multi_blocks_byte_size", thrift.I32, 165)
		offset += bthrift.Binary.WriteI32(buf[offset:], p.ExchangeMultiBlocksByteSize)
...
func (p *TQueryOptions) field142Length() int {
	l := 0
	if p.IsSetEnableFixedLenToUint32V2() {
		l += bthrift.Binary.FieldBeginLength("enable_fixed_len_to_uint32_v2", thrift.BOOL, 142)
		l += bthrift.Binary.BoolLength(p.EnableFixedLenToUint32V2)
...
func (p *TQueryOptions) field143Length() int {
	l := 0
	if p.IsSetEnableSharedExchangeSinkBuffer() {
		l += bthrift.Binary.FieldBeginLength("enable_shared_exchange_sink_buffer", thrift.BOOL, 143)
		l += bthrift.Binary.BoolLength(p.EnableSharedExchangeSinkBuffer)
...
func (p *TQueryOptions) field144Length() int {
	l := 0
	if p.IsSetEnableInvertedIndexSearcherCache() {
		l += bthrift.Binary.FieldBeginLength("enable_inverted_index_searcher_cache", thrift.BOOL, 144)
		l += bthrift.Binary.BoolLength(p.EnableInvertedIndexSearcherCache)
...
func (p *TQueryOptions) field145Length() int {
	l := 0
	if p.IsSetEnableInvertedIndexQueryCache() {
		l += bthrift.Binary.FieldBeginLength("enable_inverted_index_query_cache", thrift.BOOL, 145)
		l += bthrift.Binary.BoolLength(p.EnableInvertedIndexQueryCache)
...
func (p *TQueryOptions) field146Length() int {
	l := 0
	if p.IsSetFuzzyDisableRuntimeFilterInBe() {
		l += bthrift.Binary.FieldBeginLength("fuzzy_disable_runtime_filter_in_be", thrift.BOOL, 146)
		l += bthrift.Binary.BoolLength(p.FuzzyDisableRuntimeFilterInBe)
...
func (p *TQueryOptions) field147Length() int {
	l := 0
	if p.IsSetProfileLevel() {
...
func (p *TQueryOptions) field163Length() int {
	l := 0
	if p.IsSetInvertedIndexCompatibleRead() {
		l += bthrift.Binary.FieldBeginLength("inverted_index_compatible_read", thrift.BOOL, 163)
		l += bthrift.Binary.BoolLength(p.InvertedIndexCompatibleRead)
...
func (p *TQueryOptions) field164Length() int {
	l := 0
	if p.IsSetCheckOrcInitSargsSuccess() {
		l += bthrift.Binary.FieldBeginLength("check_orc_init_sargs_success", thrift.BOOL, 164)
		l += bthrift.Binary.BoolLength(p.CheckOrcInitSargsSuccess)
...
func (p *TQueryOptions) field165Length() int {
	l := 0
	if p.IsSetExchangeMultiBlocksByteSize() {
		l += bthrift.Binary.FieldBeginLength("exchange_multi_blocks_byte_size", thrift.I32, 165)
		l += bthrift.Binary.I32Length(p.ExchangeMultiBlocksByteSize)
...
func (p *TRuntimeFilterInfo) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TRuntimeFilterInfo[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *TRuntimeFilterInfo) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *TRuntimeFilterInfo) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *TRuntimeFilterInfo) FastWrite(buf []byte) int {
	return 0
}

func (p *TRuntimeFilterInfo) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "TRuntimeFilterInfo")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
	}
...
func (p *TRuntimeFilterInfo) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("TRuntimeFilterInfo")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *TRuntimeFilterInfo) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetRuntimeFilterParams() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "runtime_filter_params", thrift.STRUCT, 1)
		offset += p.RuntimeFilterParams.FastWriteNocopy(buf[offset:], binaryWriter)
		offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	}
	return offset
...
func (p *TRuntimeFilterInfo) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetTopnFilterDescs() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "topn_filter_descs", thrift.LIST, 2)
		listBeginOffset := offset
		offset += bthrift.Binary.ListBeginLength(thrift.STRUCT, 0)
		var length int
		for _, v := range p.TopnFilterDescs {
...
func (p *TRuntimeFilterInfo) field1Length() int {
	l := 0
	if p.IsSetRuntimeFilterParams() {
		l += bthrift.Binary.FieldBeginLength("runtime_filter_params", thrift.STRUCT, 1)
		l += p.RuntimeFilterParams.BLength()
		l += bthrift.Binary.FieldEndLength()
	}
	return l
...
func (p *TRuntimeFilterInfo) field2Length() int {
	l := 0
	if p.IsSetTopnFilterDescs() {
		l += bthrift.Binary.FieldBeginLength("topn_filter_descs", thrift.LIST, 2)
		l += bthrift.Binary.ListBeginLength(thrift.STRUCT, len(p.TopnFilterDescs))
		for _, v := range p.TopnFilterDescs {
			l += v.BLength()
		}
...
func (p *TPipelineFragmentParamsList) FastReadField14(buf []byte) (int, error) {
	offset := 0

	tmp := NewTRuntimeFilterInfo()
	if l, err := tmp.FastRead(buf[offset:]); err != nil {
		return offset, err
	} else {
		offset += l
	}
	p.RuntimeFilterInfo = tmp
	return offset, nil
}
...
func (p *TPipelineFragmentParamsList) fastWriteField14(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetRuntimeFilterInfo() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "runtime_filter_info", thrift.STRUCT, 14)
		offset += p.RuntimeFilterInfo.FastWriteNocopy(buf[offset:], binaryWriter)
		offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	}
	return offset
}
...
func (p *TPipelineFragmentParamsList) field14Length() int {
	l := 0
	if p.IsSetRuntimeFilterInfo() {
		l += bthrift.Binary.FieldBeginLength("runtime_filter_info", thrift.STRUCT, 14)
		l += p.RuntimeFilterInfo.BLength()
		l += bthrift.Binary.FieldEndLength()
	}
	return l
}
