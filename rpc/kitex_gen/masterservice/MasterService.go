...
type TTabletInfo struct {
	...
	VersionCount   *int64                 `thrift:"version_count,9,optional" frugal:"9,optional,i64" json:"version_count,omitempty"`
...
var TTabletInfo_VersionCount_DEFAULT int64

func (p *TTabletInfo) GetVersionCount() (v int64) {
	if !p.IsSetVersionCount() {
		return TTabletInfo_VersionCount_DEFAULT
	}
...
func (p *TTabletInfo) SetVersionCount(val *int64) {
	p.VersionCount = val
}
...
func (p *TTabletInfo) IsSetVersionCount() bool {
...
func (p *TTabletInfo) ReadField20(iprot thrift.TProtocol) error {
	p.CooldownMetaId = types.NewTUniqueId()
	if err := p.CooldownMetaId.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *TTabletInfo) writeField9(oprot thrift.TProtocol) (err error) {
	if p.IsSetVersionCount() {
		if err = oprot.WriteFieldBegin("version_count", thrift.I64, 9); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *TTabletInfo) DeepEqual(ano *TTabletInfo) bool {
	...
	if !p.Field9DeepEqual(ano.VersionCount) {
		return false
	}
...
type TFinishTaskRequest struct {
	...
	TabletIdToDeltaNumRows map[int64]int64                    `thrift:"tablet_id_to_delta_num_rows,18,optional" frugal:"18,optional,map<i64:i64>" json:"tablet_id_to_delta_num_rows,omitempty"`
}
...
var TFinishTaskRequest_TabletIdToDeltaNumRows_DEFAULT map[int64]int64

func (p *TFinishTaskRequest) GetTabletIdToDeltaNumRows() (v map[int64]int64) {
	if !p.IsSetTabletIdToDeltaNumRows() {
		return TFinishTaskRequest_TabletIdToDeltaNumRows_DEFAULT
	}
	return p.TabletIdToDeltaNumRows
}
...
func (p *TFinishTaskRequest) SetTabletIdToDeltaNumRows(val map[int64]int64) {
	p.TabletIdToDeltaNumRows = val
}
...
var fieldIDToName_TFinishTaskRequest = map[int16]string{
	...
	16: "copy_time_ms",
	17: "succ_tablets",
	18: "tablet_id_to_delta_num_rows",
}
...
func (p *TFinishTaskRequest) IsSetTabletIdToDeltaNumRows() bool {
	return p.TabletIdToDeltaNumRows != nil
}
...
func (p *TFinishTaskRequest) ReadField1(iprot thrift.TProtocol) error {
	p.Backend = types.NewTBackend()
	if err := p.Backend.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *TFinishTaskRequest) ReadField4(iprot thrift.TProtocol) error {
	p.TaskStatus = status.NewTStatus()
	if err := p.TaskStatus.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *TFinishTaskRequest) writeField18(oprot thrift.TProtocol) (err error) {
	if p.IsSetTabletIdToDeltaNumRows() {
		if err = oprot.WriteFieldBegin("tablet_id_to_delta_num_rows", thrift.MAP, 18); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteMapBegin(thrift.I64, thrift.I64, len(p.TabletIdToDeltaNumRows)); err != nil {
			return err
		}
...
func (p *TFinishTaskRequest) DeepEqual(ano *TFinishTaskRequest) bool {
	...
	if !p.Field18DeepEqual(ano.TabletIdToDeltaNumRows) {
		return false
	}
	return true
}
...
func (p *TFinishTaskRequest) Field18DeepEqual(src map[int64]int64) bool {
	...
	if len(p.TabletIdToDeltaNumRows) != len(src) {
		return false
	}
	for k, v := range p.TabletIdToDeltaNumRows {
		_src := src[k]
